...
const Impact: React.FC<ImpactProps> = ({ isLeyRep }) => {
  ...
  return (
    <div className="relative font-sans bg-[#f0f4f0] min-h-screen text-slate-900 max-w-md md:max-w-2xl xl:max-w-5xl mx-auto pb-28 xl:pb-8 animate-in fade-in slide-in-from-right-4 duration-500 overflow-hidden">
