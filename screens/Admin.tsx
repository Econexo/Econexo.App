...
const Admin: React.FC = () => {
    ...
    const handleGenerateCR = async () => {
        ...
        generateCR(
            { company_name: selectedUser.company_name, rut: selectedUser.rut, address: selectedUser.address || 'Chile', contact_name: selectedUser.full_name, contact_email: selectedUser.company_email },
